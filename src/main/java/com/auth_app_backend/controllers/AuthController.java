...
public class AuthController {
    ...
    public ResponseEntity<TokenResponse> login(
        ...
        String refreshToekn = jwtService.generateRefreshToken(user, refreshTokenOb.getJti());

        // use cookie service to attach refresh token in cookie
        cookieService.attachRefreshCookie(response, refreshToekn, (int) jwtService.getRefreshExpirationInMillis());
        cookieService.addNoStoreHeaders(response);

        TokenResponse tokenResponse = TokenResponse.of(accessToken, refreshToekn, jwtService.getJwtExpirationInMillis(),
    ...
    public ResponseEntity<TokenResponse> refreshToken(
        ...
        var newRefreshTokenOb = RefreshToken.builder()
                ...
                .user(user)
                .createdAt(Instant.now())
                .expiresAt(Instant.now().plusSeconds(jwtService.getRefreshExpirationInMillis()))
                .revoked(false)
                .build();
        ...
        cookieService.attachRefreshCookie(response, newRefreshToken, (int) jwtService.getRefreshExpirationInMillis());
        cookieService.addNoStoreHeaders(response);
        return ResponseEntity
                .ok(TokenResponse.of(newAccessToken, newRefreshToken, jwtService.getJwtExpirationInMillis(),
                        mapper.map(user, UserDto.class)));
